...
from tapirus.engine.graph.query.generator.services.recommendation import RecommendationQueryGenerator
...
from tapirus.engine.compute import ranking
...
class RecommendationHandler:
    ...
    def get(args):
        ...
        if args["type"] in ["oivt", "oipt", "oiv", "oip", "anon-oiv", "anon-oip", "ct-oivt", "ct-oipt"]:
        ...
        if args["type"] in ["oiv", "oip", "anon-oiv", "anon-oip"]:
