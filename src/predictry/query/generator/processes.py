...
from predictry.query.generator.base import ProcessQueryGeneratorBase
...
class RecommendationQueryGenerator(ProcessQueryGeneratorBase):
    ...
    def generate(self, args):
        ...
        #other items viewed
            ...
            '''
            query.append("MATCH (i :ITEM :%s {id : {itemId}})<-[ :%s]-(u :USER :%s)\n" % (organization, action(qtype), organization))
            query.append("MATCH (x :ITEM :%s)<-[r :%s]-(u)\n" % (organization, action(qtype)))
