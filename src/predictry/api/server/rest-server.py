...
from predictry.api.server.apis.resources import ItemAPI, ItemListAPI, UserAPI, UserListAPI, ActionAPI, ActionListAPI
from predictry.api.server.apis.services import RecommendationAPI
...
if __name__ == '__main__':
    #cProfile.run('app.run(port=5000, debug=True)')
    #logging.info(__name__ + " is running on port 5000")
